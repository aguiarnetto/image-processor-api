...
def process_image():
    ...
    try:
        ...
        # Ajuste para intensificar preto e reduzir cinza
        ...
        # Ajuste final para preto mais intenso e menos cinza
        ...
        return send_file(img_io, mimetype="image/png", as_attachment=False, download_name="processed.png")
